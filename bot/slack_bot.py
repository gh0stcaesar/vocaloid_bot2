...
def handle_command(command, channel):
    ...
    if command.startswith("search "):
        ...
        print('https://www.googleapis.com/youtube/v3/search?part=snippet%2CcontentDetails%2Cstatus&order=Relevance&q='+search_str+'&type=video&key=AIzaSyD7CsWp3uxChY6fpJzBf1fFlj4r7W6Wk9o')
